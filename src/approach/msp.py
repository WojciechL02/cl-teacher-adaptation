...
class Appr(Inc_Learning_Appr):
    ...
    def train_epoch(self, t, trn_loader):
        ...
        for images, targets in trn_loader:
            ...
            targets_new = targets.to(self.device, non_blocking=True)
    ...
    def criterion(self, t, outputs, targets, outputs_old=None, targets_old=None, return_partial_losses=False):
