...
for seed in 0 1 2; do
  ./experiments/ft_nmc.sh 0 ${seed} ${tag} ${dataset} ${num_tasks} ${nc_first_task} ${network} ${num_epochs} ${lr} ${head_init} ${stop_at_task} 1 ${exemplars} ${bsz} &
done
wait
