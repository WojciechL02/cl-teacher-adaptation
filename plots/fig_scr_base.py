...
def main():
    ...
    fig, axes = plt.subplots(1, 2, figsize=(12.80, 4.80))  # , width_ratios=[1, 1, 1, 1]

    os.environ['WANDB_API_KEY'] = '434fcc1957118a52a224c4d4a88db52186983f58'

    plot_cifar100x10(axes[0], xlabel="Finished Task", ylabel="Task 1 Accuracy")
    plot_in10(axes[1], xlabel='Finished Task', ylabel=None)

    output_path_png = output_dir / "fig_scr_base.png"
    output_path_pdf = output_dir / "fig_scr_base.pdf"
    plt.tight_layout()
