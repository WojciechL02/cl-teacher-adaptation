...
def main():
    ...
    plot_lwf(axes[0], xlabel="Finished Task", ylabel="Task 1 Accuracy")
    plot_ewc(axes[1], xlabel="Finished Task", ylabel=None)
    plot_ssil(axes[2], xlabel='Finished Task', ylabel=None)

    output_path_png = output_dir / "apx_merged_appr_taw.png"
    output_path_pdf = output_dir / "apx_merged_appr_taw.pdf"
    plt.tight_layout()
